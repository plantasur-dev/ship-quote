...
import AgecyFormContainer from "../components/ship-quote/admin/agencies/agency-form/agency-form-container";
...
function UpdateAgencyPage() {
    ...
    const jumbotron = {
        ...
        description: 'Visualiza los carrier y configura sus reglas de cotización.',
        actions: <RouteButton title={ 'Atrás' } to={ -1 } icon={ Undo2 } />
    };

    return (
        <LayoutAdminPage jumbotron={ jumbotron }>
            <AgecyFormContainer mode={ 'update' }/>
        </LayoutAdminPage>
    );
